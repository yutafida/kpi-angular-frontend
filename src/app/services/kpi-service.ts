...
export class KpiService {
	...
	// =====================================================
        ...
        getMonthlyWriteUpDashboard(
                month: ReportMonth,
                year: number
        ): Observable<MonthlyWriteUpDashboard> {
        ...
        getQuarterlyWriteUpDashboard(
                quarter: ReportQuarter,
                year: number
        ): Observable<QuarterlyWriteUpDashboard> {
  ...
  submitGeneralMonthlyReport(
    reportMonth: ReportMonth,
    reportYear: number,
    content: string
  ): Observable<GeneralMonthlyWriteUp> {
  ...
  submitGeneralQuarterlyReport(
    reportQuarter: ReportQuarter,
    reportYear: number,
    content: string
  ): Observable<GeneralQuarterlyWriteUp> {
  ...
  submitAirComponentMonthlyReport(
    airComponentId: number,
    reportMonth: ReportMonth,
    reportYear: number,
    content: string
  ): Observable<AirComponentMonthlyWriteUp> {
  ...
  submitAirComponentQuarterlyReport(
    airComponentId: number,
    reportQuarter: ReportQuarter,
    reportYear: number,
    content: string
  ): Observable<AirComponentQuarterlyWriteUp> {
  ...
  getAirComponentQuarterlyWriteUp(
    reportQuarter: ReportQuarter,
    reportYear: number,
    airComponentId: number
  ): Observable<AirComponentQuarterlyWriteUp> {
...
// import { WriteUpScope } from '../shared/write-up-scope';
// import { ReportPeriod } from '../shared/report-period';


// // Dashboard-only period type — separate from ReportPeriod (write-ups) since
// // the dashboard also supports YEARLY, which ReportPeriod does not define.
// export type DashboardPeriod = 'MONTHLY' | 'QUARTERLY' | 'YEARLY';
// export type ReportQuarter = 'Q1' | 'Q2' | 'Q3' | 'Q4';
...
//   // =====================================================
//   // KPI REPORT WRITE-UPS (monthly / quarterly, general / air-component)
//   // =====================================================

//   submitMonthlyKpiReport(
//     reportMonth: ReportMonth,
//     reportYear: number,
//     scope: WriteUpScope,
//     content: string,
...
//     const payload = {
//       periodType: ReportPeriod.MONTHLY,
//       reportMonth,
//       reportYear,
//       scope,
//       airComponentId,
...
//     return this.http.post<KpiReportWriteUp>(
//       `${this.baseUrl}/reports/generate`,
//       payload
//     );
//   }

//   submitQuarterlyKpiReport(
//     reportQuarter: ReportQuarter,
//     reportYear: number,
//     scope: WriteUpScope,
//     content: string,
...
//     const payload = {
//       periodType: ReportPeriod.QUARTERLY,
//       reportQuarter,
//       reportYear,
//       scope,
//       airComponentId,
...
//     if (airComponentId !== undefined) {
//       params = params.set('airComponentId', airComponentId);
//     }

//     return this.http.get<KpiReportWriteUp>(
//       `${this.baseUrl}/reports/monthly/${reportMonth}/${reportYear}`,
//       { params }
//     );
//   }

//   getQuarterlyWriteUpReport(
//     reportQuarter: ReportQuarter,
//     reportYear: number,
//     scope: WriteUpScope,
//     airComponentId?: number
...
//     return this.http.get<KpiReportWriteUp>(
//       `${this.baseUrl}/reports/quarterly/${reportQuarter}/${reportYear}`,
//       { params }
//     );
//   }
